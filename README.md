...
As I played around with Kong already in the past, I looked into it again for this problem. Kong offers a AI Proxy plugin, but that does not suit my needs. I just want to be able to route to different endpoints based on the model ID specified in the body of a request.

So this is the result of some tests. I used also the opportunity over the easter weekend to test my tasks against different LLMs for coding & reviewing. So yes - this code contains large portions of AI generated code, too.
...
* one or more GPUs (or multiple systems with GPUs for your vLLM instances)
...
* VS Code Insider
* Zed (short test drive - comparing against VS Code)
